...
void grabRotate(){
  if (grab_stat > 0){
    digitalWrite(GRAB_D1, 1); digitalWrite(GRAB_D2, 0);
  } else if(grab_stat < 0){
    digitalWrite(GRAB_D1, 0); digitalWrite(GRAB_D2, 1);
  }else { digitalWrite(GRAB_D1, 0); digitalWrite(GRAB_D2, 0);}
}
...
void setup() {
  ...
  // Grab PINs activating

  pinMode(GRAB_D1, OUTPUT);
  pinMode(GRAB_D2, OUTPUT);


  digitalWrite(GRAB_D1, 1);
  digitalWrite(GRAB_D2, 0);
  delay(2000);
  digitalWrite(GRAB_D1, 0);
  digitalWrite(GRAB_D2, 0);
  delay(200);
  digitalWrite(GRAB_D1, 0);
  digitalWrite(GRAB_D2, 1);
  delay(2000);
  digitalWrite(GRAB_D1, 0);
  digitalWrite(GRAB_D2, 0);
